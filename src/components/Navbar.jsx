  ...
  return (
    <div className={!showShadowNav ? 'fixed w-full h-[80px] flex justify-between items-center px-4  text-gray-300 z-20':'fixed w-full h-[80px] flex justify-between items-center px-4 text-gray-300 z-20 shadow-2xl'}>
      ...
      <ul className="hidden md:flex">
        ...
        <li className="hover:text-[#30d5c8] hover:translate-y-1 hover:duration-200 active:text-[#30d5c8]">
      ...
      <div className={
        ...
        >
          ...
          <li className="py-6 text-4xl hover:text-[#30d5c8] hover:translate-y-1 hover:duration-200 active:text-[#30d5c8]">
        ...
        {/* <div className="mt-10 text-[#30d5c8]">
        ...
        <ul>
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-slate-200 rounded-e-2xl font-semibold">
            <a
              ...
              className="flex justify-between items-center w-full text-[#000000]"
            >
